      ...
      <div>
          <div className="container notice">
              <div className="jumbotron">
                ...
                <p>If you wish to use copyrighted material published on this site for your own purposes that go beyond fair use, you must obtain permission from the copyright owner, We recommend that you seek the advice of legal counsel if you have any questions on this point.</p>
                <p>if you believe that any content or postings on this site violate your intellectual property or other rights, please <Link to="/contact" data-toggle="tooltip" data-placement="bottom" title="contact us">contact me</Link></p>
              </div>
          </div>
      </div>
  );
